...
import logo from "../assest/baby.png";
...
const Header = () => {
  ...
  return (
    <header className="shadow-md w-full z-100 m-0 h-30 px-2 md:px-4 z-50 bg-yellow-400 flex items-center justify-between">
        ...
        <Link to="/">
          <div className="flex items-center">
            <img
              ...
              alt="Farm Logo"
            />
            <h1 className="text-4xl font-bold">Baby Joy</h1>
          </div>
        </Link>
      </div>
