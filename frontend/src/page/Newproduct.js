    ...
    <div className="p-4">
       <form className='m-auto w-full max-w-md  shadow flex flex-col p-3 bg-white' onSubmit={handleSubmit}>
        ...
        <select className='bg-slate-200 p-1 my-1' id='category' name='category' onChange={handleOnChange} value={data.category}>
          ...
          <option value={"Baby_gates"}>Baby_gates</option>
          <option value={"Cabinet Locks"}>Cabinet Locks</option>
          <option value={"Outlet Covers"}>Outlet Covers</option>
          <option value={"Furniture"}>Furniture</option>
          <option value={"Edge & Corner Guards"}>Edge Guards</option>
          <option value={"Safety Straps & Anchors"}>Safety Straps </option>
          <option value={"Baby Monitors"}>Baby Monitors</option>
          <option value={"Baby Proofing Kits"}>Proofing Kits</option>
          <option value={"Organic Toys"}>Organic Toys</option>
